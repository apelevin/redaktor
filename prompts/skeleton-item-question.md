...
### `short` (Краткий)
- Задавай вопросы **ТОЛЬКО** по критично важным параметрам, без которых нельзя сформулировать пункт
- Пропускай вопросы, если информацию можно взять из общих норм права
- Минимизируй количество вопросов - только самое необходимое

### `standard` (Стандартный)
- Задавай вопросы по стандартным параметрам, которые обычно уточняются в типовом договоре
- Баланс между полнотой информации и количеством вопросов
- Используй текущие правила генерации вопросов

### `extended` (Расширенный)
- Задавай больше уточняющих вопросов для детализации
- Уточняй дополнительные аспекты, которые могут быть важны
- Не бойся задавать вопросы для более точной формулировки

### `expert` (Экспертный)
- Задавай вопросы для большинства пунктов, где это возможно
- Максимальная детализация - уточняй все аспекты, которые могут повлиять на формулировку
- Стремись к максимально точной и полной информации
